...
int i=st.executeUpdate("insert into editoras(nome,cidade)values('"+nome+"','"+cidade+"')");
out.println("<br><p>Editora Adicionada com Sucesso!</p>");
}
catch(Exception e)
{
System.out.print(e);
...
<a href="http://localhost:8080/ProjetoIntegradorLivraria/adicionar%20Usuario%20e%20Editora/EditoraForm.jsp" class="btn btn-success" >Voltar</a>
</div>
